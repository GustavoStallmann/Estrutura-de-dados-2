...
/* 
 * Export the bounding box of a form to the svg file as a dashed rectangle
 * @param svg_file the file reference
 * @param form the form to get the bounding box from
 * @param form_type the form identifier
 */
...
/* 
 * Export all sub-bounding boxes of the SMU Treap to the svg file
 * @param svg_file the file reference
 * @param treap the SMU Treap structure
 */
